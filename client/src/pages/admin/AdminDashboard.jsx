    ...
    <div className={`min-h-screen pt-16 ${darkMode ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-800"}`}>
      ...
      <div className="md:ml-64 p-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm">
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-medium text-gray-700 dark:text-gray-200">Service Request Categories</h3>
              <button
              ...
              <thead className="bg-gray-50 dark:bg-gray-700">
                {["id", "name", "email", "role", "status"].map((field) => (
                  <th
                    ...
                    className="px-4 py-2 text-gray-500 dark:text-gray-200 cursor-pointer"
                  >
                    {field.toUpperCase()}
                  </th>
                ))}
        ...
        {/* Notifications */}
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm">
          <h3 className="font-medium text-gray-700 dark:text-gray-200 mb-4">Notifications</h3>
